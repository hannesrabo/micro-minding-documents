...
######################################################################
COPY ./micro-minding-documents /go/src/github.com/hannesrabo/micro-minding/micro-minding-documents

# Compiling the protobuffer for gRPC
RUN ./micro-minding-documents/build/build-protobuff.sh

# Installing and building go code
WORKDIR /go/src/github.com/hannesrabo/micro-minding/micro-minding-documents/app
RUN go get ./
RUN go build
